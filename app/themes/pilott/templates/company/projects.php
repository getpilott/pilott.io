...
<section class="section-padding _blue">
    ...
    <section class="projects">
      <div class="projects__wrap">
        <article class="projects__item _white match-h">
          <img class="projects__icon" width="auto" height="150" src="<?= get_template_directory_uri();?>/dist/images/shifter-logo--color.svg" alt="">
          <h2 class="sm-sans projects__title">Shifter</h2>
